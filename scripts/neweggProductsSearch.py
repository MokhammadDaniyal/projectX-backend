...
def exctractProductsOnPage(page):
    ...
    paginationText = pagination.find('span', class_='list-tool-pagination-text')
...
def extractProductInfo(itemCell):
  ...
  price_strong = itemCell.find('li', class_='price-current').find('strong').text.strip()
  price_sup = itemCell.find('li', class_='price-current').find('sup').text.strip()
